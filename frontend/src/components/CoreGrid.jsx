            ...
            >
              ...
              <div className="w-full h-10 mt-1 rounded bg-slate-200/70 dark:bg-black/30 relative overflow-hidden flex items-end">
                <div
                  ...
                  style={{ height: `${Math.min(100, val)}%`, backgroundColor: color, boxShadow: `0 0 6px ${color}66` }}
                />
              </div>
              <span className="data-num text-[10px] font-bold mt-1" style={{ color }}>{val.toFixed(0)}%</span>
            </div>
          );
        })}
      </div>
